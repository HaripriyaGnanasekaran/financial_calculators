...
print('Historical annual returns for', tickerSymbol_GOOG, 'over the past', num_years, 'years:')
print(annual_returns_GOOG)

print('Historical annual returns for', tickerSymbol_SP500, 'over the past', num_years, 'years:')
