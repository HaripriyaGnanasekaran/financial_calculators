...
class ReadHistoricalData:
    ...
    def process(self, column):
        if column == "Free_Cash_Flow":
            self.df[column] = self.df["Cash Flow From Operating Activities"] + self.df["Net Change In Property Plant And Equipment"]
...
if __name__ == "__main__":
    ...
    plt.hist(free_cash_flow["FCF_Change"], bins=20, density=True, alpha=0.25, label="Growth Rate Distribution")
